        ...
        <div class="col-lg-12">
            <div class="reply-area">
                <div class="left">
                    ...
                    @else
                    <img class="img-circle"src="{{ $message->conversation->sent->photo != null ? asset('storage/images/users/'.$message->conversation->sent->photo) : asset('assets/images/noimage.png') }}"alt="">
                    @endif
        ...
        <div class="col-lg-12">
            <div class="reply-area">
                ...
                <div class="right">
                    ...
                    @else
                    <img class="img-circle" src="{{ $message->conversation->recieved->photo != null ? asset('storage/images/users/'.$message->conversation->recieved->photo) : asset('assets/images/noimage.png') }}" alt="">
                    @endif
