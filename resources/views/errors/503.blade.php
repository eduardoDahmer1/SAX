...
<body>
    <section class="maintenance-lp"
        ...
        <div class="boxmaintenance-infos {{ $gs->is_dark_mode ? ' dark' : '' }}">
            <h2 class="animate__animated">Em manutenção</h2><img class="animate__animated maintenance-image"
            ...
            </h5>@php $social = App\Models\Socialsetting::find(1); @endphp<ul
                class="list-socials {{ $gs->is_dark_mode ? ' dark' : '' }}">
                <li><a target="_blank" href="{{ $social->facebook }}"><i style="animation-delay:.7s;"
                            class="fab fa-facebook-f animate__animated"></i></a></li>
                <li><a target="_blank" href="{{ $social->instagram }}"><i style="animation-delay:.7s;"
                            class="fab fa-instagram animate__animated"></i></a></li>
                <li><a target="_blank"
                        href="https://api.whatsapp.com/send?phone={{ $gs->whatsapp_number }}&text=Ol%C3%A1!"><i
                            style="animation-delay:.7s;" class="fab fa-whatsapp animate__animated"></i></a></li>
                <li><a target="_blank" href="{{ $social->linkedin }}"><i style="animation-delay:.7s;"
                            class="fab fa-linkedin-in animate__animated"></i></a></li>
            </ul>
        </div>
