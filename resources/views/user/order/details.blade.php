...
@section('content')
<style>.pix {display: flex;font-size: 16px !important;font-weight: bold;align-items: center;}</style>
                        ...
                        <div class="view-order-page">
                            ...
                            @if (now() < $order->pay42_due_date)
                                ...
                                <div class="col-md-12" style="display:flex; justify-content:center">
                                    <a class="btn btn-success m-3" href="{{ $order->pay42_billet }}"
                                            ...
                                            <tr>
                                                ...
                                                <td width="40%">
                                                    ...
                                                    <div class="d-flex mt-2">
                                                        <b>{{ __('Color') }}</b>: <span id="color-bar" style="border: 10px solid {{ $product['color'] == ''
                                                            ? "
                                                                                                                    white"
                                                            : '#' . $product['color'] }};"></span>
                                                    </div>
