        ...
        <div class="row">
            ...
            <div class="col-lg-8 text-center">
                ...
                <div id="receipt_card" class="account-info">
                    ...
                    <img id="preview" width="350px" src="{{ $order->receipt ? asset('storage/images/receipts/'.$order->receipt) : '' }}" alt="">
                ...
                @else
                <div class="header-area">
                    <h4 class="titlereceipt">{{ __("This order should not contain a receipt.") }}</h4>
                </div>
                @endif
            </div>
        </div>
