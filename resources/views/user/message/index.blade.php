                                ...
                                <table id="example" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="conv">
                                            ...
                                            <td>{{ $user->id == $conv->sent->id ? $conv->recieved->name : $conv->sent->name }}</td>
                                            <td>{{ $conv->subject }}</td>
...
<script type="text/javascript">
    $(document).on("submit", "#emailreply", function() {
        ...
        $('#eml, #subj, #msg, #emlsub').prop('disabled', true);
        $.ajax({
            type: 'post',
            ...
            success: function(data) {
                $('#eml, #subj, #msg').prop('disabled', false).val('');
                $('#emlsub').prop('disabled', false);
                if (data == 0) toastr.error("{{ __('Email Not Found') }}");
