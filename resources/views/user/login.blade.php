            ...
            <div class="col-lg-6">
                <nav class="comment-log-reg-tabmenu">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link login active" id="nav-log-tab" data-toggle="tab" href="#nav-log" role="tab" aria-controls="nav-log" aria-selected="true">{{ __("Login") }}</a>
                        <a class="nav-item nav-link" id="nav-reg-tab" data-toggle="tab" href="#nav-reg" role="tab" aria-controls="nav-reg" aria-selected="false">{{ __("Register") }}</a>
                    </div>
                </nav>
                        ...
                        <div class="login-area">
                            ...
                            <div class="login-form signin-form">
                                ...
                                <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                                    ...
                                    <div class="form-input">
                                        <input type="password" id="passw" class="Password" name="password" placeholder="{{ __('Type Password') }}" required="">
                                    ...
                                    <div class="form-forgot-pass">
                                        ...
                                        <div class="right">
                                            <a href="{{ route('user-forgot') }}">{{ __("Forgot Password?") }}</a>
                                        </div>
                                    </div>
                        ...
                        <div class="login-area signup-area">
                            ...
                            <div class="login-form signup-form">
                                ...
                                <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
                                    ...
                                    <div class="form-input">
                                        <input type="password" id="register_password" class="Password" name="password" placeholder="{{ __('Password') }}" required="">
                                        <span toggle="#register_password" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                        <i class="icofont-ui-password"></i>
                                    </div>
                                    <div class="form-input">
                                        <input type="password" id="confirmation_password" class="Password" name="password_confirmation" placeholder="{{ __('Confirm Password') }}" required="">
                                    ...
                                    <div class="form-forgot-pass">
                                        <div class="left">
                                            ...
                                            <label for="agree_privacy_policy">{{ __("I agree with the") }} <a target="_blank" href="{{ $url ? route('front.privacypolicy') : ""  }}">{{ __("Privacy Policy") }}</a> {{ __("And the") }}<a target="_blank" href="{{ $url_terms ? route('front.crowpolicy') : ""  }}">{{ __("Terms of use") }}</a>.</label>
                                        </div>
                                    </div>
