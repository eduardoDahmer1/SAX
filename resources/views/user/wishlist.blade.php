        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="pages">
                    ...
                    <li><a href="{{ route('user-wishlists') }}">{{ __("Wishlists") }}</a></li>
                </ul>
            </div>
        </div>
    </div>
</div>
<section><img src="{{ asset('assets/front/themes/theme-15/assets/images/Banner_Sax.png') }}" class="img-fluid w-100"></section>
    ...
    <div class="container">
        ...
        <div class="right-area">
            ...
            <div id="ajaxContent">
                <div class="row wish-list-area">
                    ...
                    <div class="col-lg-6">
                        <div class="single-wish">
                            ...
                            <div class="left"><img src="{{ $wishlist->photo ? asset('storage/images/products/'.$wishlist->photo):asset('assets/images/noimage.png') }}"alt=""></div>
                            <div class="right">
                                <h4 class="title"><a href="{{ route('front.product', $wishlist->slug) }}">{{ $wishlist->name }}</a></h4>
                                @if($gs->is_rating == 1)
                    ...
                    <div class="col-lg-6">
                        <div class="single-wish">
                            ...
                            <div class="left"><img src="{{filter_var($wishlist->product->photo, FILTER_VALIDATE_URL) ? $wishlist->product->photo : asset('storage/images/products/'.$wishlist->product->photo)}}" alt=""></div>
                            <div class="right">
                                <h4 class="title"><a href="{{ route('front.product', $wishlist->product->slug) }}">{{ $wishlist->product->name }}</a></h4>
                                @if($gs->is_rating == 1)
                                <ul class="stars">
                                    <div class="ratings">
                ...
                <div style="padding-bottom: 100px;" class="page-center category">{{ $wishlists->appends(['sort' => $sort])->links() }}</div>
            </div>
        </div>
        @else
