                ...
                <div class="user-profile-details">
                    <div class="order-history">
                        <div class="header-area">
                            ...
                            <h4 class="title">{{ __('Order Number:') }} {{ $conv->order_number }}</h4>
                            @endif
                            <h4 class="title">{{ __('Subject:') }} {{ $conv->subject }} <a class="mybtn1"href="{{ url()->previous() }}"> <i class="fas fa-arrow-left"></i>{{ __('Back') }}</a></h4>
                        </div>
                                ...
                                <div class="panel-body" id="messages">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="reply-area">
                                                    ...
                                                    <div class="right">
                                                        ...
                                                        @else
                                                        <img class="img-circle"src="{{ $message->conversation->user->photo != null ? asset('storage/images/users/' . $message->conversation->user->photo) : asset('assets/images/noimage.png') }}"alt="">
                                                        @endif
                                    ...
                                    <div class="single-reply-area admin">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="reply-area">
                                                    <div class="left"><img class="img-circle" src="{{ asset('storage/images/admin.jpg') }}" alt=""><p class="ticket-date">{{ __('Admin') }}</p></div>
