...
@section('styles')
<style>.disabled {pointer-events: none;opacity: 0.5;}</style>
...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Affiliate Product') }} <a class="add-btn" href="javascript:history.back();"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                <ul class="links">
                    <li><a href="{{ route('vendor-dashboard') }}">{{ __('Dashbord') }} </a></li>
                    <li><a href="javascript:;">{{ __('Affiliate Products') }} </a></li>
                    <li><a href="{{ route('vendor-import-index') }}">{{ __('All Affiliate Products') }}</a></li>
                    <li><a href="{{ route('vendor-import-create') }}">{{ __('Add Affiliate Product') }}</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="body-area">
                        ...
                        <form id="geniusform" action="{{ route('vendor-import-store') }}" method="POST"
                            ...
                            <div class="row border-sep">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Product Affiliate Link') }}*<span>{{ __('(External Link)') }}</span></h4>
                                        <input type="text" class="input-field" placeholder="{{ __('Product Affiliate Link') }}" name="affiliate_link" required="">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="input-form">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        <div class="d-flex"><h4 class="heading">{{ __('Product Current Price') }}*<span>({{ __('In') }} {{ $sign->name }})</span></h4></div>
                                        <input name="price" step="0.1" type="number" class="input-field"placeholder="{{ __(' e.g 20') }}" required="" min="0">
                                    </div>
                                </div>
                                <div class="col-xl-6"><div class="input-form"><h4 class="heading">{{ __('Product Sku') }}* </h4><input type="text" class="input-field"placeholder="{{ __('Enter Product Sku') }}" name="sku" required=""value="{{ $temp_sku }}"></div></div>
                                <div class="col-xl-6">
                                    <div class="input-form">
...
$("#feature-btn").on('click', function() {
    ...
    $('#feature-section').append('' +
        ...
        Enter Your Keyword ') }}">' +
        '</div>' +
        @foreach($locales as $loc) @if($loc - > locale === $lang - >
        locale) @continue @endif '<div role="tabpanel" class="tab-pane" id="{{ $loc->locale }}-features' +
        current_feature +
        '">' +
        ...
        '</li>' +
        @foreach($locales as $loc) @if($loc - > locale === $lang - >
        locale) @continue @endif '<li role="presentation">' +
