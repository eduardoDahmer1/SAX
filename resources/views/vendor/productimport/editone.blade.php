    ...
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    <li><a href="{{ route('vendor-import-index') }}">{{ __('Dashbord') }} </a></li>
                        ...
                        <form id="geniusform" action="{{ route('vendor-import-update', $data->id) }}" method="POST"
                                        ...
                                        <div class="input-form">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12">
                                                    ...
                                                    @php
                                                    $catOptChecked = is_array($selectedAttrs) &&
                                        ...
                                        <div class="input-form">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12">
                                                    ...
                                                    @php
                                                    $subcatOptChecked = is_array($selectedAttrs) &&
                                        ...
                                        <div class="input-form">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12">
                                                    ...
                                                    @php
                                                    $childcatOptChecked = is_array($selectedAttrs) &&
                            ...
                            <div class="row border-sep">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form"
                                        ...
                                        <div class="row">
                                            <div class="panel panel-body">
                                                ...
                                                <div class="buttons">
                                                    <div class="deleteImage" onclick="deleteImage({{ $data->id }})">
                                                    </div>
                                                </div>
                                                @endif
                                    ...
                                    <div id="f-link" class="input-form" {!! !filter_var($data->photo,
                                        FILTER_VALIDATE_URL) ? 'style="display:none"' : '' !!}>
