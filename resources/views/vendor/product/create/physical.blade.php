...
<div class="content-area">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li><a href="{{ route('vendor-prod-physical-create') }}">{{ __('Physical Product') }}</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="product-description">
                    <div class="body-area">
                        ...
                        <form id="geniusform" action="{{ route('vendor-prod-store') }}" method="POST"
                            ...
                            <div class="title-section-form"><span>1</span>
                                <h3>{{ __('Mandatory Data') }}</h3>
                            </div>
                            <div class="row border-sep">
                                <div class="col-12">
                                    <div class="input-form">
                                        ...
                                        @slot('placeholder') {{ __('Enter Product Name') }} @endslot
                                        {{ __('Product Name') }}*
                                        @endcomponent
                                        @php
                                        $temp_sku = Illuminate\Support\Str::random(3) . substr(time(), 6, 8) .
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        <div class="d-flex">
                                            <h4 class="heading">{{ __('Product Current Price') }}*<span>({{ __('In') }}
                                                    {{ $sign->name }})</span></h4>
                                        </div>
                            ...
                            <div class="title-section-form"><span>2</span>
                            ...
                            <div class="row border-sep">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="showbox input-form">
                                            ...
                                            @slot('name') ship @endslot
                                            @slot('placeholder') {{ __('Estimated Shipping Time') }} @endslot
                                                        ...
                                                        <div class="size-area">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4 col-sm-6">
                                                                    <label>{{ __('Size Name') }} :
                                                                        <span>{{ __('(eg. S,M,L,XL,XXL,3XL,4XL)') }}</span></label>
                                                                    <input type="text" name="size[]" class="input-field"
                                                                        placeholder="{{ __(' Size Name') }}">
                                                                </div>
                                                                <div class="col-md-4 col-sm-6">
                                                                    <label>{{ __('Size Qty') }} :
                                                                        <span>{{ __('(Number of quantity of this size)') }}</span></label>
                                                                ...
                                                                <div class="col-md-4 col-sm-6">
                                                                    <label>{{ __('Size Price') }} :
                                                                        <span>{{ __("(This price will be added with base price)") }}</span></label>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="showbox">
                                        <div class="input-form product-size-details">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label>{{ __('Product Colors') }}<span>{{ __('(Choose Your Favorite Colors)') }}</span></label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label>{{ __('Color Qty') }}<span>{{ __('(Number of quantity of this Color)') }}</span></label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label>{{ __('Color Price') }}<span>{{ __('(This price will be added with base price)') }}</span></label>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Maximum Quantity per Sale') }}<span>(Un.)</span></h4>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Product Weight') }}<span>(Kg.)</span></h4>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Product width') }}<span>(cm.)</span></h4>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Product height') }}<span>(cm.)</span></h4>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Product length') }}<span>(cm.)</span></h4>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="featured-keyword-area input-form">
                                            <h4 class="heading">
                                                {{ __('Feature Tags') }}<span>{{ __('(You can create up to 2 Product Tags)') }}</span>
                                            </h4>
                                                            ...
                                                            <div class="panel panel-lang">
                                                                <div class="panel-body">
                                                                    <div class="tab-content">
                                                                        ...
                                                                        @if ($loc->locale === $lang->locale) @continue
                                                                        @endif
                                                            ...
                                                            <ul class="nav nav-pills" role="tablist">
                                                                <li role="presentation" class="active">
                                                                    <a href="#{{ $lang->locale }}-features0"
                                                                        ...
                                                                        role="tab"
                                                                        data-toggle="tab">{{ $lang->language }}</a>
                                                                </li>
                                                                @foreach ($locales as $loc)
                                                                @if ($loc->locale === $lang->locale) @continue @endif
                                                                <li role="presentation">
                                                                    <a href="#{{ $loc->locale }}-features0"
                                                                        aria-controls="{{ $loc->locale }}-features0"
                                                                        role="tab"
                                                                        data-toggle="tab">{{ $loc->language }}</a>
                                                                </li>
                                                                @endforeach
                                                            </ul>
                                                        </div>
    ...
    $(document).ready(function() {
        function updateStock() {
            var total = 0;
            $("input[name='color_qty[]'], input[name='size_qty[]']").each(function() {
                total += parseInt($(this).val()) || 0;
            });
            $("#stock").val(total || null);
        }
        $("input[name='color_qty[]'], input[name='size_qty[]']").on('keyup', updateStock);
        $("#check3, #size-check").change(function() {
            var isChecked = $(this).is(":checked");
            $("#stock").attr("readonly", isChecked).toggleClass("disabled", isChecked);
            if (isChecked) updateStock();
        });
    });
    ...
    $('#feature-btn').on('click', function() {
        current_feature++;
        var html = '<div class="feature-area mb-3">' +
            '<span class="remove feature-remove"><i class="fas fa-times"></i></span>' +
            '<div class="row mb-0">' +
            '<div class="col-lg-6"><div class="panel panel-lang"><div class="panel-body"><div class="tab-content">' +
            '<div role="tabpanel" class="tab-pane active" id="{{ $lang->locale }}-features' + current_feature +
            '">' +
            '<input type="text" name="{{ $lang->locale }}[features][]" class="input-field" placeholder="{{ __('
        Enter Your Keyword ') }}">' +
            '</div>';
        @foreach($locales as $loc)
        @if($loc - > locale !== $lang - > locale)
        html += '<div role="tabpanel" class="tab-pane" id="{{ $loc->locale }}-features' + current_feature +
            '">' +
            '<input type="text" name="{{ $loc->locale }}[features][]" class="input-field" placeholder="{{ __('
        Enter Your Keyword ') }}">' +
            '</div>';
        @endif
        @endforeach
        html += '</div></div></div></div>' +
            '<div class="col-lg-6"><div class="input-group colorpicker-component cp">' +
            '<input type="text" name="colors[]" value="#000000" class="input-field cp"/>' +
            '<span class="input-group-addon"><i></i></span></div></div></div>' +
            '<div class="panel panel-lang"><div class="panel-footer"><ul class="nav nav-pills" role="tablist">' +
            '<li role="presentation" class="active">' +
            '<a href="#{{ $lang->locale }}-features' + current_feature +
            '" class="active" aria-controls="{{ $lang->locale }}-features' + current_feature +
            '" role="tab" data-toggle="tab">{{ $lang->language }}</a>' +
            '</li>';
        @foreach($locales as $loc)
        @if($loc - > locale !== $lang - > locale)
        html += '<li role="presentation"><a href="#{{ $loc->locale }}-features' + current_feature +
            '" aria-controls="{{ $loc->locale }}-features' + current_feature +
            '" role="tab" data-toggle="tab">{{ $loc->language }}</a></li>';
        @endif
        @endforeach
    ...
    $("#uploadgallery").change(function() {
        ...
        for (var i = 0; i < total_file; i++) {
            ...
            $('.selected-image .row').append(
                '<div class="col-sm-6"><div class="img gallery-img"><span class="remove-img"><i class="fas fa-times"></i><input type="hidden" value="' +
                i + '"></span><a href="' + imgURL + '" target="_blank"><img src="' + imgURL +
                '" alt="gallery image"></a></div></div>');
    ...
    script src = "{{ asset('assets/admin/js/product.js') }}" >
    </script>
    </script>