                    ...
                    <div class="body-area">
                        ...
                        <form id="geniusformdata" action="{{route('vendor-package-store')}}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Price') }} *<span>({{ __('In') }} {{ $sign->name }})</span></h4>
                                        <input type="number" class="input-field" name="price" placeholder="{{ __('Price') }}" required="" value="" min="0" step="0.01">
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-center"><button class="addProductSubmit-btn" type="submit">{{ __('Create Package') }}</button></div>
                        </form>
                    </div>
                </div>
            </div>
