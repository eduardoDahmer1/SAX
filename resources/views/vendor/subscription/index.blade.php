        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li><a href="{{ route('vendor-subscription-index') }}">{{ __("Subscription") }}</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="elegant-pricing-tables style-2 text-center">
                    ...
                    <small>{{ __('Expired on:') }} {{ date('d/m/Y', strtotime($user->date)) }}</small>
                    @else
                    <small>{{ __('Ends on:') }} {{ date('d/m/Y', strtotime($user->date)) }}</small>
                    @endif
                    <br><a href="{{ route('user-vendor-request', $sub->id) }}" class="btn btn-default">{{ __('Renew') }}</a>
                    @else
