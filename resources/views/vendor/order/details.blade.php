        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="special-box">
                    ...
                    <div class="footer-area"><a href="{{ route('vendor-order-invoice', $order->order_number) }}" class="mybtn1"><i class="fas fa-eye"></i> {{ __('View Invoice') }}</a></div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="special-box">
                ...
                <form method="POST" action="{{ route('vendor-order-license', $order->order_number) }}" id="edit-license"
                    ...
                    <div class="form-group text-center">
                        <input type="text" name="{{ __(' Save License') }}"
                            ...
                            required=""><input type="submit" name="submit" value="Save License" class="btn btn-primary"
