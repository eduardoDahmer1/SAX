        ...
        <div class="blog-box" style="min-height: 387px;">
            ...
            <div class="details">
                ...
                <ul style="text-align: center;">
                    ...
                    <li>
                        <p class="blog-text">
                            <i class="fab fa-skype" aria-hidden="true" style="color: #0078d4"></i>
                            <a class="team_contacts_skype" href="skype:{{substr(strip_tags($member->skype), 0, 120)}}">{{substr(strip_tags($member->skype), 0, 120)}}</a>
                        </p>
                    </li>
                    @endif
                    @if($member->email)
                    <li>
                        <p class="blog-text">
                            <i class="fa fa-envelope" aria-hidden="true" style="color: #d93025"></i>
                            <a class="team_contacts_email" href="mailto:{{substr(strip_tags($member->email), 0, 120)}}">{{substr(strip_tags($member->email), 0, 120)}}</a>
                        </p>
                    </li>
                    @endif
                </ul>
