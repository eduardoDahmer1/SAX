                ...
                <div class="modal-body">
                    <nav class="comment-log-reg-tabmenu">
                        <div class="nav nav-tabs" id="nav-tab1" role="tablist">
                            <a class="nav-item nav-link login active" id="nav-log-tab11" data-toggle="tab" href="#nav-log11" role="tab" aria-controls="nav-log" aria-selected="true">{{ __('Vendor Login') }}</a>
                            <a class="nav-item nav-link" id="nav-reg-tab11" data-toggle="tab" href="#nav-reg11" role="tab" aria-controls="nav-reg" aria-selected="false">{{ __('Vendor Registration') }}</a>
                        </div>
                    </nav>
                                ...
                                <div class="login-form signin-form">
                                    ...
                                    <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
                                        ...
                                        <div class="form-forgot-pass">
                                            ...
                                            <div class="right">
                                                <a href="javascript:;" id="show-forgot1">{{ __('Forgot Password?') }}</a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="social-area">
                                                ...
                                                <ul class="social-links">
                                                    ...
                                                    @if ($socials->g_check == 1)
                                                        <li><a href="{{ route('social-provider', 'google') }}"><i class="fab google"></i></a></li>
                                                    @endif
                                                </ul>
                                            </div>
                                        @endif
