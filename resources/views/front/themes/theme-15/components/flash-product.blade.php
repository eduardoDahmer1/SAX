...
<div class="card-product-flash">
    <a href="{{ route('front.product', $prod->slug) }}" class="item" data-aos="fade-in"
        ...
        <div
            ...
            <img class="img-fluid" src="{{ filter_var($prod->thumbnail, FILTER_VALIDATE_URL)
                            ? $prod->thumbnail
                            : asset('storage/images/thumbnails/' . $prod->thumbnail) }}" alt="{{ $prod->showName() }}">
            @if ($gs->is_rating == 1)
            <div class="stars">
                <div class="ratings">
