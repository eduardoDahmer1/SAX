        ...
        <div class="container">
            <div class="row justify-content-between align-items-center align-items-lg-end" style="position: relative;">
                <div class="col-lg-2 col-2 order-2 order-lg-1" style="position: static;">
                    <div class="button-open-search"><input type="checkbox"><i class="fa fa-search"
                ...
                <div class="col-lg-8 col-4 order-3 order-lg-2 d-flex justify-content-center p-0">
                    <div class="logo">
                        <!-- LOGO PRETA (Para o modo light) -->
                        <a href="{{ route('front.index') }}" class="logo-light"><img src="{{ $gs->logoUrl }}"
                                alt=""></a>
                        <!-- LOGO BRANCA (Para o modo dark) -->
                        <a href="{{ route('front.index') }}" class="logo-dark"><img loading="lazy"
                                src="{{ $gs->footerLogoUrl }}" alt="{{ $gs->title }}"></a>
                    </div>
                </div>
                <!-- MODE WHITE -->
                <div id="mode-dark" class="col-lg-2 col-4 order-4 order-lg-3" style="display: none;">
                        ...
                        <ul class="helpful-links-inner">
                            <li data-toggle="tooltip" data-placement="top" class="loginbutton"
                                ...
                                @if (!Auth::guard('web')->check())<a href="{{ route('user.login') }}"
                                    class="profile carticon"><img class="img-fluid icons-header"
                                        src="{{ asset('assets/images/theme15/ICON-LOGIN.png')}}" alt=""></a>
                                @else
                                <a href="{{ route('user-dashboard') }}" class="profile carticon"><img
                                        class="img-fluid icons-header"
                                        src="{{ asset('assets/images/theme15/ICON-LOGIN-CHECK.png')}}" alt=""></a>
                                @endif
                            </li>
                            ...
                            <li class="wishlist" data-toggle="tooltip" data-placement="top" title="{{ __('Wish') }}">
                                ...
                                <a href="{{ route('user-wishlists') }}" class="wish"><img class="img-fluid icons-header"
                                        src="{{ asset('assets/images/theme15/ICON-CART.png')}}" alt=""><span
                            ...
                            <li class="my-dropdown"><a href="javascript:;" class="cart carticon">
                                    <div class="icon"><img class="img-fluid icons-header"
                                            src="{{ asset('assets/images/theme15/ICON-BAG.png')}}" alt=""><span
                                            class="cart-quantity"
                ...
                <!-- MODE WHITE -->
                <!-- MODE DARK -->
                <div id="mode-light" class="col-lg-2 col-4 order-4 order-lg-3" style="display: none;">
                    <div class="helpful-links">
                        <ul class="helpful-links-inner">
                            <li data-toggle="tooltip" data-placement="top" class="loginbutton"
                                title="{{ !Auth::guard('web')->check() ? __('Login') :  __('Profile') }}">
                                @if (!Auth::guard('web')->check())<a href="{{ route('user.login') }}"
                                    class="profile carticon"><img class="img-fluid icons-header"
                                        src="{{ asset('assets/images/theme15/ICON-LOGIN-PRETO.png')}}" alt=""></a>
                                @else
                                <a href="{{ route('user-dashboard') }}" class="profile carticon"><img
                                        class="img-fluid icons-header"
                                        src="{{ asset('assets/images/theme15/ICON-LOGIN-CHECK-PRETO.png')}}" alt=""></a>
                                @endif
                            </li>
                            @if (!env('ENABLE_SAX_BRIDAL'))
                            <li class="wishlist" data-toggle="tooltip" data-placement="top" title="{{ __('Wish') }}">
                                @if (Auth::guard('web')->check())
                                <a href="{{ route('user-wishlists') }}" class="wish"><img class="img-fluid icons-header"
                                        src="{{ asset('assets/images/theme15/ICON-CART-PRETO.png')}}" alt=""><span
                                        id="wishlist-count">{{ count(Auth::user()->wishlists) }}</span></a>
                                @else
                                <a href="javascript:;" data-toggle="modal" id="wish-btn" data-target="#comment-log-reg"
                                    class="wish"><img class="img-fluid icons-header"
                            ...
                            <li class="my-dropdown"><a href="javascript:;" class="cart carticon">
                                    <div class="icon"><img class="img-fluid icons-header"
                                            src="{{ asset('assets/images/theme15/ICON-BAG-PRETO.png')}}" alt=""><span
                                            class="cart-quantity"
                                            id="cart-count">{{ Session::has('cart') ? count(Session::get('cart')->items) : '0' }}</span>
                                    </div>
                                </a>
                ...
                <div class="col-lg-12 col-2 order-1 order-lg-4">
                    <div class="saxnavigation">
                        <svg class="icone-menu-nav" width="35" height="24" viewBox="0 0 35 24" fill="none"
                        ...
                        <ul class="menu-navigation">
                            ...
                            <li class="menudrop"><a class="navlink"
                                    href="{{ route('front.categories') }}">{{ __('Categories') }}<svg version="1.1"
                                        id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="15px"
                                        viewBox="0 0 201.457 201.457" xml:space="preserve">
                                        <g>
                                            <path style="fill:currentColor;"
                                                d="M46.233,8.279L54.513,0l100.729,100.723L54.495,201.457l-8.279-8.28l92.46-92.46L46.233,8.279z" />
                                        </g>
                                    </svg></a></li>
                            ...
                            <li><a class="navlink" target="_blank"
                                    href="https://shop.saxdepartment.com/">{{ __('Institutional') }}</a></li>
                            <li><a class="navlink" target="_blank"
                                    href="https://shop.saxdepartment.com/sax-palace">{{ __('Sax Palace') }}</a></li>
                            <li><a class="navlink" target="_blank"
                                    href="https://shop.saxdepartment.com/sax-bridal">{{ __('SAX Bridal') }}</a></li>
                            @if (!Auth::guard('web')->check())
                            <li class="login-button-menu"><a class="navlink"
                                    href="{{ route('user-dashboard') }}">{{ __('Profile') }}</a></li>
                            @else
                            <li class="login-button-menu"><a class="navlink"
                ...
                <div class="col-6 col-lg-10 d-flex justify-content-center align-items-center">
                    <div class="categories_menu vertical">
                        <div class="categories_title">
                            <h2 class="categori_toggle"><i class="fas fa-layer-group"></i> {{ __('Categories') }}<i
...
<div class="categories_menu horizontal">
    <div class="categories_title_horizontal">
        <h2 class="categori_toggle"><i class="fa fa-bars"></i> {{ __('Categories') }}<i
                class="fa fa-angle-down arrow-down"></i></h2>
    </div>
    <div class="categories_menu_inner_horizontal">
        <ul>
            ...
            @endphp
            @if ($i == 6)
            <li><a href="{{ route('front.categories') }}"><i class="fas fa-plus"></i>{{ __('See All Categories') }}</a>
            </li>
            @break
            @endif
            @endforeach
...
<div class="col-6 col-lg-2">
    <div class="box-button-site" data-menu-toggle-main="#menu-browse-site"><i class="fas fa-bars"></i>
        <p>{{ __('Browse the site') }}</p>
        <div id="menu-browse-site" class="container-menu"></div>
    </div>
</div>
</div> --}}
</div>
