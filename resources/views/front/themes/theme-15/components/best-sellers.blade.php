            ...
            <div class="col-lg-2 remove-padding d-none d-lg-block">
                <div class="aside">
                    ...
                    <a class="banner-effect sider-bar-align" href="{{ $ps->best_seller_banner_link }}">
                        <img loading="lazy" src="{{asset('storage/images/banners/'.$ps->best_seller_banner)}}" alt="Banner lateral da Shop Sax"
                            style="width:100%;border-radius: 5px;">
                    </a>
                    @endif
                    @if($ps->best_seller_banner1)
                    <a class="banner-effect sider-bar-align" href="{{ $ps->best_seller_banner_link1 }}">
                        <img loading="lazy" src="{{asset('storage/images/banners/'.$ps->best_seller_banner1)}}" alt="Banner lateral da Shop Sax"
                            style="width:100%;border-radius: 5px;">
                    </a>
                    @endif
                </div>
