@if($ps->best == 1 && $best_products->isNotEmpty())
<section class="phone-and-accessories categori-item">
    <div class="container">
            ...
            <div class="col-lg-12 remove-padding">
                <div class="section-top text-center">
                    ...
                    <h5 data-aos="fade-in" data-aos-delay="100">
                        {{ __("Discover the most popular products among our customers and don't be left behind.") }}
                    </h5>
                </div>
            </div>
        </div>
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-10">
                <div class="row">
                    @foreach($best_products->take(8) as $prod)
                ...
                <div class="aside">
                    @if($ps->best_seller_banner)
                        <a class="banner-effect sider-bar-align" href="{{ $ps->best_seller_banner_link }}">
                            <img class="lazyload" data-src="{{ asset('storage/images/banners/'.$ps->best_seller_banner) }}" alt="Banner Shop Sax" style="width:100%;border-radius: 5px;">
                        </a>
                    @endif
                    @if($ps->best_seller_banner1)
                        <a class="banner-effect sider-bar-align" href="{{ $ps->best_seller_banner_link1 }}">
                            <img class="lazyload" data-src="{{ asset('storage/images/banners/'.$ps->best_seller_banner1) }}" alt="Banner Shop Sax" style="width:100%;border-radius: 5px;">
                        </a>
                    @endif
                </div>
            </div>
