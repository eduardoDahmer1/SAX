                        ...
                        <ul class="filter">
                            <div class="single-filter">
                                ...
                                <div class="form-check ml-0 pl-0">
                                    <input name="{{$attr->input_name}}[]" class="form-check-input attribute-input"
                                        type="checkbox" id="{{$attr->input_name}}{{$option->id}}"
                                        value="{{$option->id}}">
                                ...
                                <div class="form-check  ml-0 pl-0">
                                    <input name="{{$att->input_name}}[]" class="form-check-input attribute-input"
                                        type="checkbox" id="{{$att->input_name}}{{$option->id}}"
                                        value="{{$option->id}}">
                                    <label class="form-check-label"
                                        for="{{$att->input_name}}{{$option->id}}">{{$option->name}}</label>
                                </div>
                                @endforeach
                                @endif
                                @endforeach
