                                    ...
                                    <div class="input-form">
                                        ...
                                        <div class="img-upload full-width-img">
                                            ...
                                            @if(str_contains(url()->previous(), 'bottom'))
                                                <p class="text">{{ __('Preferred Size: (400x630) or Square Sized Image') }}</p>
                                            @elseif(str_contains(url()->previous(), 'top'))
                                                <p class="text">{{ __('Preferred Size: (1300x600) or Square Sized Image') }}</p>
                                            @else
                                                <p class="text">{{ __('Preferred Size: (1275x500) or Square Sized Image') }}</p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="input-form">
                                        ...
                                        @foreach($storesList as $store)
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" name="stores[]" id="store{{$store->id}}" value="{{$store->id}}" 
