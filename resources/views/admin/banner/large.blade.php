...
@section('styles')
    <style>
        ...
        .add-btn { padding: 0 30px; margin-bottom: 20px; }
    </style>
@endsection
@section('content')
...
@section('scripts')
    <script>
        var qtde = 0;
        function tableRowCountReset() { qtde = 0; sessionStorage.setItem("CurrentPage", 0); }
        var table = $('#geniustable').DataTable({
            ...
            drawCallback: function() {
                $('#geniustable_length').on('change', function() { tableRowCountReset(); table.ajax.reload(); });
            },
