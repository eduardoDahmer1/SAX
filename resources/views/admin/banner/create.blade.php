                                ...
                                <div class="col-xl-6">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Link') }} * 
                                            <i class="icofont-question-circle" data-toggle="tooltip" data-placement="top" style="display:inline-block" title="{{ __('Link that will open when the object get clicked') }}"></i>
                                        </h4>
