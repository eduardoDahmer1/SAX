    ...
    <div class="mr-breadcrumb">
        <div class="row">
            ...
            <ul class="links">
                ...
                <li><a href="{{ route('admin-order-index') }}">{{ __('Billet') }}</a></li>
            </ul>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="input-form">
                    <div class="table-responsive" style="overflow-x:hidden;">
                        ...
                        <h6>{{ __('Total') . ': ' . $order->currency_sign }}{{ number_format($order->pay_amount * $order->currency_value, $order_curr->decimal_digits, $order_curr->decimal_separator, $order_curr->thousands_separator) }}
                        </h6>
                        @if ($billet['status_request']['status'] == 'pending')<span
                        ...
                        @elseif($billet['status_request']['status'] == 'paid')<span
                            class="badge badge-success">{{ __('Billet Status') . ': ' . __('Paid') }}</span>
                        @endif
                    </div>
                </div>
            </div>
