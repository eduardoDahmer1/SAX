        ...
        <div class="row product-description">
            <div class="col-lg-12 body-area">
                <form id="aex-request-form" action="{{ route('admin-order-request-aex') }}" method="POST"
                    ...
                    @if (!empty($aex_track))
                    <div class="alert alert-warning validation"><button type="button"
                            class="close alert-close"><span>×</span></button>
                        <ul class="text-left">{{__('This order already has an AEX request')}}</ul>
                    </div>
                    @endif
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <span>{{ $order->shipping_city == null ? $order->customer_city : $order->shipping_city }} -
