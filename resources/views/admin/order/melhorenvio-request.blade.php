            ...
            <div class="col-lg-12 body-area">
                <form id="melhorenvio-request-form" action="{{ route('admin-order-cart-melhorenvio') }}" method="POST"
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <input name="from[name]" class="input-field" value="{{ $melhorenvio_settings->from_name }}"
                                required>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <input name="from[city]" class="input-field" value="{{ $melhorenvio_settings->from_city }}"
                                required>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <input name="from[note]" class="input-field" value="{{ $melhorenvio_settings->from_note }}">
                        </div>
                    </div>
                    <div class="row justify-content-center mt-5">
                        <div class="col-lg-3">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <input name="to[document]" class="input-field"
                                value="{{ $order->shipping_document == null ? $order->customer_document : $order->shipping_document }}"
                                required>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <input name="to[district]" class="input-field"
                                value="{{ $order->shipping_district == null ? $order->customer_district : $order->shipping_district }}"
                                required>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <select name="to[state]" required>
                                <option value="">{{ __('Select State') }}</option>
                                @php
                                $to_state = $order->shipping_state == null ? $order->customer_state :
                                $order->shipping_state;
                                @endphp
                                @foreach($states as $state)
                                <option {{$state->name == $to_state ? "selected":""}} value="{{ $state->initial }}">
                                    {{$state->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <input name="to[note]" class="input-field" value="">
                        </div>
                    </div>
                    <div class="row justify-content-center mt-5">
                        <div class="col-lg-3">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <input name="options[invoice][number]" class="input-field" id="invoice-number" value=""
                                {{ $selected_company != 1 ? 'required' : ''}}>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <input name="options[invoice][key]" class="input-field" id="invoice-key" value=""
                                {{ $selected_company != 1 ? 'required' : ''}}>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <input name="options[reminder]" class="input-field" value="">
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-6">
                            <input name="coupon" class="input-field" value="">
                        </div>
                    </div>
                    <div class="row justify-content-center mt-5">
                        <div class="col-lg-3">
                    ...
                    <div id="products">
                        ...
                        <div id="cart_item[{{$item_index}}]" class="cart-item" data-index="{{$item_index}}">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-1">
                                    <input name="products[{{$item_index}}][quantity]" class="input-field" type="number"
                                ...
                                <div class="col-lg-2">
                                    <input name="products[{{$item_index}}][unitary_value]" class="input-field"
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <button type="button" class="btn btn-success text-white" id="add-item"><i
...
$('#agency_city').on('change', function() {
    ...
    Object.values(agencies).forEach(function(element) {
        html += '<option value="' + element['id'] + '">' + element['company_name'] + ' - ' + element[
            'district'] + ' - ' + element['address'] + '</option>';
    });
    $("#agency").html(html);
});
@endif
...
$('#add-item').on('click', function() {
    ...
    var html = '' +
        ...
        '</div>' +
        '<div class="col-lg-2">' +
        '<input name="products[' + new_index +
        '][unitary_value]" class="input-field" type="number" step="0.01"' +
        'value="">' +
        '</div>' +
        '<div class="col-lg-1">' +
        '</div>' +
