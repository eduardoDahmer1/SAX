                ...
                <div class="col-xl-6">
                  <div class="input-form">
                    ...
                    <div class="img-upload">
                      <div id="image-preview" class="img-preview" style="background: url('{{ $data->photo ? asset('storage/images/categories/'.$data->photo) : asset('assets/images/noimage.png') }}');">
                        @if ($data->photo)
                          <div class="buttons">
                        ...
                        <label for="image-upload" class="img-label" id="image-label">
                          <i class="icofont-upload-alt"></i>{{ __('Upload Icon') }}
                        </label>
                ...
                <div class="col-xl-6">
                  ...
                  <div class='input-form {{ $data->is_featured == 0 ? "showbox" : "" }}'>
                    ...
                    <div class="img-upload">
                      ...
                      @endif
                      <div id="image-preview" class="img-preview" style="background: url('{{ $data->image ? asset('storage/images/categories/'.$data->image) : asset('assets/images/noimage.png') }}');">
                ...
                <div class="col-xl-12">
                  <div class="input-form">
                    ...
                    <div class="img-upload full-width-img">
                      @if ($data->banner)
                      <div class="buttons">
                        <div class="deleteImage" onclick="deleteBanner({{ $data->id }}, 'banner', this)"></div>
                      </div>
                      @endif
                      <div id="image-preview" class="img-preview" style="background: url('{{ $data->banner ? asset('storage/images/categories/banners/'.$data->banner) : asset('assets/images/noimage.png') }}');">
                        <label for="image-upload" class="img-label" id="image-label">
                          <i class="icofont-upload-alt"></i>{{ __('Upload Image') }}
                        </label>
