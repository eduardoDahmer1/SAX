                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 hidden">
                                    <div class="input-form">
                                        ...
                                        <input type="text" class="input-field less-width" name="times" placeholder="{{ __('Enter Value') }}" value="">
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Minimum Value') }}</h4>
                                        <input type="text" class="input-field less-width" name="minimum_value" placeholder="{{ __('Enter minimum value') }}" value="">
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Maximum Value') }}</h4>
                                        <input type="text" class="input-field less-width" name="maximum_value" placeholder="{{ __('Enter minimum value') }}" value="">
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div class="input-form">
