        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li><a href="{{ route('admin-faq-index') }}">{{ __('Faq') }}</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    var table = $('#geniustable').DataTable({
        ...
        initComplete: function() {
            $(".btn-area").append('<div class="col-sm-4 text-right"><a class="add-btn" data-href="{{ route('admin-faq-create') }}" data-header="{{ __('Add New Faq') }}" id="add-data" data-toggle="modal" data-target="#modal1"><i class="fas fa-plus"></i> {{ __('Add New Faq') }}</a></div>');
