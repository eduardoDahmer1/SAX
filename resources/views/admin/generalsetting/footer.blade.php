        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li><a href="{{ route('admin-gs-footer') }}">{{ __('Footer') }}</a></li>
                                ...
                                <div class="col-xl-12">
                                    <div class="input-form">
                                        @component('admin.components.input-localized', ['from' => $admstore, 'type' => 'textarea'])
                                            @slot('name') footer @endslot
                                            @slot('value') footer @endslot
                                ...
                                <div class="col-xl-12">
                                    <div class="input-form">
                                        @component('admin.components.input-localized', ['from' => $admstore, 'type' => 'richtext'])
                                            @slot('name') copyright @endslot
                                            @slot('value') copyright @endslot
