            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li><a href="{{ route('admin-gs-payments-index') }}">{{ __('Cash On Delivery') }}</a></li>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="input-form input-form-center">
                                            ...
                                            <div class="action-list">
                                                <select class="process select droplinks {{ $admstore->cod_check == 1 ? 'drop-success' : 'drop-danger' }}">
                                                    <option data-val="1" value="{{ route('admin-gs-cod', 1) }}" {{ $admstore->cod_check == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                    <option data-val="0" value="{{ route('admin-gs-cod', 0) }}" {{ $admstore->cod_check == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-8">
                                        <div class="input-form">
                                            @component('admin.components.input-localized', ['from' => $admstore, 'type' => 'textarea'])
                                                @slot('name') cod_text @endslot
                                                @slot('value') cod_text @endslot
