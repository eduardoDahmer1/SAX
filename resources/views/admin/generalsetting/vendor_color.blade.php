        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li><a href="{{ route('admin-gs-contents') }}">{{ __('Vendor Store Default Background') }}</a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-3">
                                    <div class="left-area">
                                        ...
                                        <small>(This background will be displayed if vendor doesn't set his / her store background)</small>
                                    </div>
                                </div>
                                <div class="col-lg-6">
