                        ...
                        <div class="body-area">
                            ...
                            <form action="{{ route('admin-gs-update') }}" id="geniusform" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="alert alert-info">
                                            ...
                                            <p>{{ __('Local zip code will use the settings registered with the General Shipping, not the address settings.') }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Store Zip Code') }}</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <input name="correios_cep" class="input-field" placeholder="{{ __('e.g 01000-000') }}" value="{{ $admstore->correios_cep }}">
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Local Zip Code Start') }}</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <input name="localcep_start" class="input-field" placeholder="{{ __('e.g 01000-000') }}" value="{{ $admstore->localcep_start }}">
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Local Zip Code End') }}</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <input name="localcep_end" class="input-field" placeholder="{{ __('e.g 01000-000') }}" value="{{ $admstore->localcep_end }}">
                                    </div>
