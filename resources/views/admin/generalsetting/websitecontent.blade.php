                        ...
                        <form action="{{ route('admin-gs-update') }}" id="geniusform" method="POST"
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Text') }}
                                            *<span>{{ __('Text over the primary theme color.') }}</span></h4>
                                        <div class="form-group">
                                            <div class="input-group colorpicker-component cp">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('Text') }}
                                            *<span>{{ __('Text over the secondary theme color.') }}</span></h4>
                                        <div class="form-group">
                                            <div class="input-group colorpicker-component cp">
                                                <input class="input-field color-field" type="text"
                            ...
                            <!-- White Mode Colors Section -->
                            <div class="title-section-form">
                                <span>4</span>
                                <h3>{{ __('White Mode Colors') }}</h3>
                            </div>
                            <div class="row">
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('White Mode Background') }} *</h4>
                                        <div class="form-group">
                                            <div class="input-group colorpicker-component cp">
                                                <input type="text" class="input-field color-field"
                                                    name="white_mode_primary_color"
                                                    value="{{ $admstore->white_mode_primary_color }}"
                                                    class="form-control cp" />
                                                <span class="input-group-addon"><i></i></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('White Mode Text') }} *</h4>
                                        <div class="form-group">
                                            <div class="input-group colorpicker-component cp">
                                                <input type="text" class="input-field color-field"
                                                    name="white_mode_text_color"
                                                    value="{{ $admstore->white_mode_text_color }}"
                                                    class="form-control cp" />
                                                <span class="input-group-addon"><i></i></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('White Mode Accent') }} *</h4>
                                        <div class="form-group">
                                            <div class="input-group colorpicker-component cp">
                                                <input type="text" class="input-field color-field"
                                                    name="white_mode_secondary_color"
                                                    value="{{ $admstore->white_mode_secondary_color }}"
                                                    class="form-control cp" />
                                                <span class="input-group-addon"><i></i></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="input-form">
                                        <h4 class="heading">{{ __('White Mode Border') }} *</h4>
                                        <div class="form-group">
                                            <div class="input-group colorpicker-component cp">
                                                <input type="text" class="input-field color-field"
                                                    name="white_mode_secondary_text_color"
                                                    value="{{ $admstore->white_mode_secondary_text_color }}"
                                                    class="form-control cp" />
                                                <span class="input-group-addon"><i></i></span>
                                            </div>
                                        </div>
