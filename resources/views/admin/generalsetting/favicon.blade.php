            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li><a href="{{ route('admin-gs-fav') }}">{{ __('Favicon') }}</a></li>
                ...
                <div class="col-lg-6">
                    ...
                    <form class="uplogo-form" id="geniusform" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="currrent-logo">
                            <h4 class="title">{{ __('Current Favicon') }} :</h4>
                            <img src="{{ $admstore->faviconUrl }}" alt="">
                        </div>
                        <div class="set-logo">
                            <h4 class="title">
                                <i class="icofont-question-circle" data-toggle="tooltip" style="display:inline-block" data-placement="top" title="{{ __('Tab icon') }}"></i>
                                {{ __('Set New Favicon') }} :
                            </h4>
