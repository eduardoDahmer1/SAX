...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">@lang('Edit Language') <a class="add-btn" href="{{ route('admin-lang-index') }}"><i class="fas fa-arrow-left"></i> @lang('Back')</a></h4>
                <ul class="links">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('Dashboard')</a></li>
                    <li><a href="{{ route('admin-lang-index') }}">@lang('Languages')</a></li>
                    <li><a href="{{ route('admin-lang-edit', $data->id) }}">@lang('Edit Language')</a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="input-form">
                                        ...
                                        <p class="input-field">{{ $data->rtl == '0' ? __('Left To Right') : __('Right To Left') }}</p>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        @foreach ($langEdit as $key => $translation)
                                                            ...
                                                            <tr>
                                                                <td>{{ $key }}<input type="hidden" name="fields[{{ $key }}][key]" value="{{ $key }}"></td>
                                                                <td><input type="text" class="input-field" name="fields[{{ $key }}][translation]" value="{{ !is_numeric($translation) ? $translation : '' }}"></td>
                                                                <td>{{ !is_numeric($translation) ? $translation : '' }}</td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
...
<script type="text/javascript">
    var table = $('#geniustable').DataTable({
        ...
        initComplete: function(settings, json) {
            $(".btn-area").append('<div class="col-sm-4 table-contents"><a class="add-btn" id="btn-empty-search">@lang('Show Empty')</a><a class="add-btn" id="btn-all-search" style="display: none;">@lang('Show All')</a></div>');
