                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="checkbox-wrapper">
                                        ...
                                        <i class="icofont-question-circle" data-toggle="tooltip" title="{{ __('SEO (Search Engine Optimization) focuses on your website presence in search results on search engines like Google') }}"></i>
                                    </div>
                                ...
                                <div class="col-xl-12">
                                    @component('admin.components.input-localized', ["type" => "tags"])
                                        ...
                                        {{ __('Tags') }} <i class="icofont-question-circle" data-toggle="tooltip" title="{{ __('It can help you tracking your blog') }}"></i>
                                    @endcomponent
                                </div>
                            </div>
