    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-center">{{ __('You are about to delete this Child Category. Everything under this child category will be deleted.') }}</p>
...
<script type="text/javascript">
    var table = $('#geniustable').DataTable({
        ...
        columns: [
            ...
            { data: 'name', render: function(data, type, row) { return row.name + '<br><small> slug: ' + row.slug + '</small>'; }},
            { data: 'category', searchable: false, orderable: false },
            { data: 'subcategory', searchable: false, orderable: false },
            { data: 'products', name: 'products', searchable: false, orderable: false },
        ...
        drawCallback: function(settings) {
            ...
            $(".checkboxStatus").on('click', function() {
                ...
                $(this).attr("name", $(this).attr("name").slice(0, -1) + statusNovo);
                $.ajax({
                    type: 'GET',
