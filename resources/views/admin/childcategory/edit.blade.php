                                ...
                                <div class="col-xl-12">
                                    <div class="input-form">
                                        ...
                                        <div class="img-upload full-width-img">
                                            <div id="image-preview" class="img-preview" style="background: url('{{ $data->banner ? asset('storage/images/childcategories/banners/'.$data->banner) : asset('assets/images/noimage.png') }}');">
