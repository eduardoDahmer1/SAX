                                ...
                                <div class="input-form">
                                        ...
                                        <div class="row mb-2 counterrow" v-for="option in options" :key="option.id">
                                            <div class="col-md-11">
                                                ...
                                                <div class="panel panel-lang">
                                                    <div class="panel-body">
                                                        <div class="tab-content">
                                                            <div role="tabpanel" class="tab-pane active" :id="'{{ $lang->locale }}-descriptionfield' + option
                                                                            .id">
                                                                <input class="input-field optionin" type="text"
                                                            ...
                                                            <template v-for="loc in locales">
                                                                <div role="tabpanel" class="tab-pane"
                                                                    ...
                                                                    v-if="option.translations_fixed[loc]">
                                                                    <input class="input-field optionin" type="text"
                                                                        :name="loc + '[description][]'" :value="option.translations_fixed[loc]
                                                                                    .description"
                                                                        placeholder="{{ __('Description') }}">
                                                                </div>
                                                                <div role="tabpanel" class="tab-pane"
                                                        ...
                                                        <ul class="nav nav-pills" role="tablist">
                                                            <li role="presentation" class="active">
                                                                <a :href="'#{{ $lang->locale }}-descriptionfield' +
                                                                        option.id" class="active" :aria-controls="'{{ $lang->locale }}-descriptionfield' +
                                                                            option.id" role="tab" data-toggle="tab">
                                                                    {{ $lang->language }}
                                                                </a>
                                                            </li>
                                                            @foreach ($locales as $loc)
                                                            ...
                                                            <li role="presentation">
                                                                <a :href="'#{{ $loc->locale }}-descriptionfield' +
                                                                            option.id" :aria-controls="'{{ $loc->locale }}-descriptionfield' +
                                                                                option.id" role="tab"
                                                                    data-toggle="tab">
                                                                    {{ $loc->language }}
                                                                </a>
                                    ...
                                    <div id="app2">
                                                        ...
                                                        <div class="tab-content">
                                                            <div role="tabpanel" class="tab-pane active"
                                                                ...
                                                                <input type="text" class="input-field"
                                                                    name="{{ $lang->locale }}[options][name][]" value=""
                                                                    placeholder="{{ __('Option label') }}" required>
                                                            </div>
                                                            @foreach ($locales as $loc)
                                                            @if ($loc->locale === $lang->locale)
                                                            ...
                                                            <div role="tabpanel" class="tab-pane"
                                                                ...
                                                                <input type="text" class="input-field"
                                                                    name="{{ $loc->locale }}[options][name][]" value=""
                                                                    placeholder="{{ __('Option label') }}">
                                                            </div>
                                                            @endforeach
                                                        </div>
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="tab-content">
                                                            <div role="tabpanel" class="tab-pane active"
                                                                ...
                                                                <input type="text" class="input-field"
                                                                    name="{{ $lang->locale }}[description][]" value=""
                                                                    placeholder="{{ __('Description') }}">
                                                            </div>
                                                            @foreach ($locales as $loc)
                                                            @if ($loc->locale === $lang->locale)
                                                            ...
                                                            <div role="tabpanel" class="tab-pane"
                                                                ...
                                                                <input type="text" class="input-field"
                                                                    name="{{ $loc->locale }}[description][]" value=""
                                                                    placeholder="{{ __('Description') }}">
                                                            </div>
                                                            @endforeach
                                                        </div>
                                        ...
                                        <button type="button" class="btn btn-success text-white" @click="addOption()"
                                            style="display:block;margin:auto;"><i class="fa fa-plus"></i>
                                ...
                                <div class="input-form">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" id="priceStatus1" name="price_status"
                                            class="custom-control-input" {{ $attr->price_status == 1 ? 'checked' : '' }}
                                            value="1">
