        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li><a href="{{ route('admin-package-index') }}">{{ __('Packagings') }}</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    var table = $('#geniustable').DataTable({
        ...
        initComplete: function(settings, json) {
            $(".btn-area").append('<div class="col-sm-4 table-contents"><a class="add-btn" data-href="{{ route('admin-package-create') }}" data-header="{{ __('Add New Packaging') }}" id="add-data" data-toggle="modal" data-target="#modal1"><i class="fas fa-plus"></i> {{ __('Add New Packaging') }}</a></div>');
