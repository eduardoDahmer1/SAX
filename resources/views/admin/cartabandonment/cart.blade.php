                                        ...
                                        <tr>
                                            <td width="50%">
                                                @if ($product['item']['user_id'] != 0)
                                                    ...
                                                    @endphp
                                                    {{ $user ? $product['item']['name'] : $product['item']['name'] }}
                                                @else
                                                    {{ $product['item']['name'] }}
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                @if ($product['size'])
                                                    <p>Size : {{ str_replace('-', ' ', $product['size']) }}</p>
                                                @endif
                                                @if ($product['color'])
                                                    <p>
                                                        {{ __('Color') }} : 
                                                        <span style="margin-left: 40px; width: 20px; height: 0.2px; display: block; border: 10px solid {{ $product['color'] == '' ? 'white' : $product['color'] }};"></span>
                                                    </p>
                                                @endif
                                                <p>
