$(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".openperfil.my-dropdown").on("mouseover", function () {
            $(".openperfil.my-dropdown .my-dropdown-menu.profile-dropdown")
                .stop()
                .show(0);
        });
        ...
        $(".openstore.my-dropdown").on("mouseover", function () {
            $(".openstore.my-dropdown .my-dropdown-menu.profile-dropdown")
                .stop()
                .show(0);
        });
        ...
        if (w > 991) {
            ...
            /*------addClass/removeClass categories-------*/
            $(".categories_menu_inner_horizontal > ul > li").on(
                "mouseover",
                function () {
                    $(this)
                        .find(".link-area a")
                        ...
                        .parent()
                        .parent()
                        .find(".categories_mega_menu, categorie_sub")
                        .addClass("open");
                    $(this)
                        .siblings()
                        .find(".categories_mega_menu, .categorie_sub")
            ...
            $(document).on("mouseover", function (e) {
                var container = $(
                    ".categories_menu_inner_horizontal,.categories_menu_inner, .categories_mega_menu, .categories_title"
                );
                ...
                if (
                    ...
                    $(".categories_mega_menu, .categorie_sub").removeClass(
                        "open"
                    );
        ...
        if (w <= 991) {
            ...
            $(document).on("click", function (e) {
                var container = $(
                    ".categories_menu_inner,.categories_menu_inner_horizontal, .categories_mega_menu, .categories_title"
                );
        ...
        if ($(".intro-content").length > 1) {
            $mainSlider.on("changed.owl.carousel", function (event) {
                var $currentItem = $(".owl-item", $mainSlider).eq(
                    event.item.index
                );

                var $class11 = $currentItem
                    .find(".subtitle")
                    .attr("data-animation");
        ...
        $("[data-countdown]").each(function () {
            ...
            $this.countdown(finalDate, function (event) {
                $this.html(
                    event.strftime(
                        "<span>%D : <small>Dias</small></span> <span>%H : <small>Hrs</small></span>  <span>%M : <small>Min</small></span> <span>%S <small>Seg</small></span>"
                    )
                );
            });
        });
    ...
    $(window).on("scroll", function () {
        ...
        if ($(window).width() > 991) {
            if ($window.scrollTop() > 45) {
                ...
                var tamanhomenu =
                    $(".nav-fixed").height() + $(".top-header").height() + 20;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Caso o checkbox não exista, aplique o tema claro fixo
    if (!themeToggle) {
    ...
    // Alternar o tema ao mudar o estado do checkbox
    themeToggle.addEventListener("change", () => {
        const theme = themeToggle.checked ? "dark-mode" : "light-mode";

        document.body.classList.replace(
            themeToggle.checked ? "light-mode" : "dark-mode",
            theme
        );

        navLinks.forEach((link) => {
            link.classList.toggle("dark-mode", theme === "dark-mode");
        });
        topHeader.classList.toggle("dark-mode", theme === "dark-mode");

        modeLight.style.display = theme === "light-mode" ? "block" : "none";
        modeDark.style.display = theme === "dark-mode" ? "block" : "none";
